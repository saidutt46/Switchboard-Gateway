...
import type { RouteCreate } from '../api/types'
          ...
          <div className="space-y-6">
            ...
            {parentService && (
              <div className="rounded-xl border bg-card">
                ...
                <Link to={`/services/${parentService.id}`} className="flex items-center justify-between px-4 py-3 hover:bg-muted/50 transition-colors">
                  <div>
